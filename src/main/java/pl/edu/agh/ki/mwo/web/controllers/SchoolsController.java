...
public class SchoolsController {
    ...
    public String displayEditStudentForm(@RequestParam(value="schoolId") String schooltId, 
    		Model model, HttpSession session) {    	
    	if (session.getAttribute("userLogin") == null)
    		return "redirect:/Login";
    	
    	model.addAttribute("school", DatabaseConnector.getInstance().getSchool(schooltId));
    	
        return "editSchoolForm";    
    }

    @RequestMapping(value="/UpdateSchool", method=RequestMethod.POST)
    public String editStudent(@RequestParam(value="schoolId", required=true) String schoolId,
