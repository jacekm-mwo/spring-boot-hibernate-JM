...
public class SchoolClassesController {
    ...
    public String displayEditSchoolCLassForm(@RequestParam(value="schoolClassId") String SchoolClassId,
    ...
    public String editSchoolClass(@RequestParam(value="schoolClassId", required=true) String schoolClassId,
           ...
           Model model, HttpSession session){    	
        	...
        	DatabaseConnector.getInstance().updateSchoolClass(schoolClassId, startYear, currentYear,  profile, schoolId);  //startYear, currentYear,
           	model.addAttribute("schoolClasses", DatabaseConnector.getInstance().getSchoolClasses());
